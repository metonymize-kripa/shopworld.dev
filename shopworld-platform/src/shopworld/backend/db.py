"""Database infrastructure for ShopWorld backend libraries.

This module is the canonical home for shared persistence helpers used by the
runtime and application simulators.  The older ``shopworld.apps.lib.db`` import
path remains as a compatibility shim while the platform is modularized into
backend libraries.
"""
