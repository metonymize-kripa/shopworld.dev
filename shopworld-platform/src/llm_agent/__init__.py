...
is a drop-in adapter for a real model.
...
from llm_agent.client import LLMClient, ScriptedLLMClient, AnthropicClient

__all__ = ["LLMAgent", "LLMClient", "ScriptedLLMClient", "AnthropicClient"]
